DROP TABLE IF EXISTS cpd_ngp_reporting_2021.c3_2021_attempts_map; 
CREATE TABLE cpd_ngp_reporting_2021.c3_2021_attempts_map AS
(
SELECT
  l.vb_reg_latitude
  , l.vb_reg_longitude
    , l.vb_vf_county_name
    , l.vb_vf_municipal_district
    , l.vb_vf_city_council
