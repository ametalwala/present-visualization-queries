...
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column vf_county varchar;
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column age int;
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column dor int;
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column reg_status varchar;
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column earliest_dor int;

update  cpd_ngp_vr_2021.c3_vr_matched_20220505 
...
where cpd_ngp_vr_2021.c3_vr_matched_20220505.vbvoterbase_id = t2.vb_voterbase_id
AND vb_vf_source_state= 'GA';

-- okay now adding county info
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column region varchar;
update cpd_ngp_vr_2021.c3_vr_matched_20220505 set region = (CASE WHEN
...
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column vr_status varchar;
update cpd_ngp_vr_2021.c3_vr_matched_20220505 set vr_status = CASE
...
alter table cpd_ngp_vr_2021.c3_vr_matched_20220505 add column correct_match varchar;
update cpd_ngp_vr_2021.c3_vr_matched_20220505 set correct_match = 'Y' WHERE vr_status in ('Re-Registrant', 'New Registrant');

GRANT ALL ON TABLE cpd_ngp_vr_2021.c3_vr_matched_20220505 TO GROUP cpd_ngp;

drop table if exists cpd_ngp_vr_2021.c3_vr_matched_current; 
create table cpd_ngp_vr_2021.c3_vr_matched_current AS
  select * from cpd_ngp_vr_2021.c3_vr_matched_20220505
  UNION ALL
